<footer id="footer" class="footer">
    <div class="footer-inner">
        <div class="copyright">
            ...
            ?>
            &copy; <?php echo $output_year; ?> <span class="with-love"> <i
                        class="icon-next-heart fa fa-heart"></i></span>
            <span class="author"><?php $username = get_option('next_author', 'admin');
                echo get_profile('display_name', $username); ?></span>
        </div>
        <div class="powered-by">Powered by <a href="//cn.wordpress.org"
                                              target="_blank">WordPress</a></div>
        <div class="theme-info">Theme <a href="https://github.com/pengtikui/NexT" target="_blank">NexT
                WP</a></div>
